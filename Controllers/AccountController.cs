...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult editprofile(editprofileViewModel profile)
        {
            ...
            {
                ViewBag.message = "the passowrd not right";
            }
            else
            {
                var newpassowrd = UserManager.PasswordHasher.HashPassword(profile.newPassword);
                currentuser.UserName = profile.username;
                currentuser.Email = profile.Email;
                currentuser.PasswordHash = newpassowrd;
                db.Entry(currentuser).State = System.Data.Entity.EntityState.Modified;
                db.SaveChanges();
                ViewBag.message = "the updates is happened";
            }
            return View(profile);
        }
        //
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ViewBag.usertype = new SelectList(db.Roles.Where(a=>!a.Name.Contains("admino")).ToList() , "Name", "name");
